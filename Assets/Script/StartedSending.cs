...
{
	public class StartedSending : MonoBehaviour
	{
		...
		public ImageMovement ImageMovement;
		...
		void Start()
		{
			...
			_message2.Add( Time.frameCount ).Add( Time.time ).Add(ImageMovement.verticalMove).Add(ImageMovement.horizontalMove);
		...
		void Update()
		{
			...
			_message2.Set( 2, ImageMovement.verticalMove);
			_message2.Set(3, ImageMovement.horizontalMove);
			_oscOut.Send( _message2 );
		}
	}
}