...
namespace OscSimpl.Examples
{
	public class ArgumentTypeTest : MonoBehaviour
	{
		...
		void Update()
		{
			...
			//Debug.Log(scriptt.horizontalMove + "!!!!!!!!!!!!!");
			SendFloat(0f);
		}
		...
		public void SendFloat( float value )
		{
			...
			oscOut.Send(floatAddress, scriptt.horizontalMove);
			//Debug.Log(scriptt.horizontalMove + "!!!!!!!!!!!!");
		...
		public void OnReceiveFloat( float value )
		{
			...
			floatInputSlider.value = scriptt.horizontalMove;
			floatInputLabel.text = scriptt.horizontalMove.ToString();
		}
